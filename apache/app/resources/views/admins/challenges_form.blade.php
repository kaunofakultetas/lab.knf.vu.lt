        ...
        <div class="content-inner w-100">
          ...
          <header class="bg-white shadow-sm px-4 py-3 z-index-20">
            <div class="container-fluid px-0">
              <h2 class="mb-0 p-1">Challenges form</h2>
            </div>
          </header>
                ...
                <div class="col-lg-12">
                  <div class="card">
                    <div class="card-header">
                      ...
                      <h3 class="h4 mb-0">Challenges form</h3>
                    </div>
                    <div class="card-body"> 
                      {{ Form::open(['url' => $url]) }}
                        <div class="mb-3">
                        ...
                        <div class="mb-3">
                          ...
                          {{ Form::select("partner_id", $partner_list, $partner_id ?? 0, ['class'=>'form-control', 'id' => 'partner', 'required'=>'required']) }}
                        </div>
                        
                        <div class="mb-3"> 
                        	<label class="form-label">Description</label>
							{{ Form::textarea('descr', $descr, ['class' => 'form-control', 'required'=>'required']) }}  
                        </div>
                        ...
                        <div class="mb-3">
                          ...
                          {{ Form::text('answer', $answer, ['class' => 'form-control', 'required'=>'required']) }} 
                        </div>
                        
                        <div class="mb-3">
                          <label class="form-label">Points</label>
                          {{ Form::number('points', $points, ['class' => 'form-control', 'required'=>'required']) }} 
                        </div>
