        ...
        <div class="content-inner w-100">
          ...
          <header class="bg-white shadow-sm px-4 py-3 z-index-20">
            <div class="container-fluid px-0">
              <h2 class="mb-0 p-1"><a href="#" onClick="history.back();"><small>&#171; Back</small></a> &nbsp;&nbsp; {{ $challenge_name }} solved by users</h2>
            </div>
          </header>
          ...
          <section class="pb-0">
            <div class="container-fluid">
             ...
             <div class="card-header">
                      ...
                      <h3 class="h4 mb-0">{{ $challenge_name }} solved by users</h3>
                    </div>
                        ...
                        <table class="table mb-0 table">
                          ...
                          @if(count($recordlist) > 0)
                            ...
                            @elseif(count($recordlist) == 0)
                            	<tr>
                            		<td colspan="7"><center>No Users who solved this challenge</center></td>
                            	</tr>
                            @endif
