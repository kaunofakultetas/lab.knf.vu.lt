            ...
            <div class="container-fluid">
             ...
             <div class="card-header">
                      <div class="card-close">
                        <div class="dropdown">
                          <a class="dropdown-toggle text-md xxsd" href="/control-panel/pages/create">
                          	<i class="fas fa-plus"></i>
                          </a>
                   
                        </div>
                      </div>
                      <h3 class="h4 mb-0">Pages</h3>
                    </div>
                      ...
                      <div class="table-responsive">
                        <table class="table mb-0 table">
                          ...
                          @if(count($recordlist) > 0)
                                ...
                                <tr> 
                                  <td>{{ $value['name'] }}</td>
                                  <td class="text-center"> <a href="/control-panel/pages/edit/{{ $value['id'] }}"><i class="fas fa-edit"></i></a> </td>
                                  <td class="text-center"> <a href="#" onClick="Confirm_Dialog('/control-panel/pages/delete/{{ $value['id'] }}');"><i class="fas fa-trash"></i></a> </td>
                                </tr>
                                <tr>  
                                @endforeach
                                
                               
                        			<tr><td colspan="3">{!! $recordlist->links()->render() !!}</td></tr>
                        	 
 
                            @elseif(count($recordlist) == 0)
                            	<tr>
                            		<td colspan="4"><center>No Pages</center></td>
                            	</tr>
                            @endif
