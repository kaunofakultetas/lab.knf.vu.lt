        ...
        <div class="content-inner w-100">
          ...
          <header class="bg-white shadow-sm px-4 py-3 z-index-20">
            <div class="container-fluid px-0">
              <h2 class="mb-0 p-1">Challenge Categories</h2>
            </div>
          </header>
            ...
            <div class="container-fluid">
             ...
             <div class="card-header">
                      <div class="card-close">
                        <div class="dropdown">
                          <button class="dropdown-toggle text-md" type="button" onClick="category_form('new');">
                      ...
                      <div class="table-responsive">
                        <table class="table mb-0 table">
                          ...
                          @if(count($recordlist) > 0)
                                ...
                                <tr> 
                                  <td>{{ $value['name'] }}</td>
                                  <td class="text-center"> <a href="#" onClick="category_form('edit', {{ $value['id'] }});"><i class="fas fa-edit"></i></a> </td>
                                  <td class="text-center"> <a href="#" onClick="Confirm_Dialog('/control-panel/category/delete/{{ $value['id'] }}');"><i class="fas fa-trash"></i></a> </td>
                                </tr>
                                <tr>  
                                @endforeach
                            ...
                            @elseif(count($recordlist) == 0)
                            	<tr>
                            		<td colspan="4"><center>No Categories</center></td>
                            	</tr>
                            @endif
