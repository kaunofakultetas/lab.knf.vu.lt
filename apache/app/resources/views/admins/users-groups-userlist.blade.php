        ...
        <div class="content-inner w-100">
          ...
          <header class="bg-white shadow-sm px-4 py-3 z-index-20">
            <div class="container-fluid px-0">
              <h2 class="mb-0 p-1">Group - {{ $group_name }}</h2>
            </div>
          </header>
            ...
            <div class="container-fluid">
             ...
             <div class="card-header">
                      <div class="card-close">
                        <div class="dropdown">
                          <a class="dropdown-toggle text-md xxsd" href="#" onClick="users_togroups_form('new', {{ $uid }});">
                          	<i class="fas fa-plus"></i>
                          </a>
                   
                        </div>
                      </div>
                      <h3 class="h4 mb-0">Group - {{ $group_name }}</h3>
                    </div>
                      ...
                      <div class="table-responsive">
                        <table class="table mb-0 table">
                          ...
                          @if(count($recordlist) > 0)
                                ...
                                <tr> 
                                  <td>{{ $value['vu_id'] }}</td>   
                                  <td class="text-center"> <a href="#" onClick="Confirm_Dialog('/control-panel/users/vu-groups/delete_group/{{ $value['id'] }}');"><i class="fas fa-trash"></i></a> </td>
                                </tr>
                                <tr>  
                                @endforeach
