        ...
        <div class="content-inner w-100">
          ...
          <header class="bg-white shadow-sm px-4 py-3 z-index-20">
            <div class="container-fluid px-0">
              <h2 class="mb-0 p-1">Challenge Partners</h2>
            </div>
          </header>
            ...
            <div class="container-fluid">
             ...
             <div class="card-header">
                      <div class="card-close">
                        <div class="dropdown">
                          <button class="dropdown-toggle text-md" type="button" onClick="partners_form('new');">
                          	<i class="fas fa-plus"></i>
                          </button>
                   
                        </div>
                      </div>
                      <h3 class="h4 mb-0">Partners</h3>
                    </div>
                      ...
                      <div class="table-responsive">
                        <table class="table mb-0 table">
                          ...
                          @if(count($recordlist) > 0)
                                ...
                                <tr> 
                                  <td>{{ $value['name'] }}</td>
                                  <td><img src="{{ env('APP_URL') }}/upload/{{ $value['picture'] }}" style="max-width:350px"></td>
                                  <td class="text-center"> <a href="#" onClick="partners_form('edit', {{ $value['id'] }});"><i class="fas fa-edit"></i></a> </td>
                                  <td class="text-center"> <a href="#" onClick="Confirm_Dialog('/control-panel/partners/delete/{{ $value['id'] }}');"><i class="fas fa-trash"></i></a> </td>
                                </tr>
                                <tr>  
                                @endforeach
                            ...
                            @elseif(count($recordlist) == 0)
                            	<tr>
                            		<td colspan="4"><center>No Partners</center></td>
                            	</tr>
                            @endif
